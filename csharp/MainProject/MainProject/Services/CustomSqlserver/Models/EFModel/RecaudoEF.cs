...
{
    [Table("ca_temp_consignaciones_ws")]
    public class RecaudoEF
    {
        ...
        [Column("contador")]
        public int? Contador { get; set; } = null;
        ...
        [Column("valor")]
        public double? Valor { get; set; } = null;
        ...
        [Column("valor_cheque")]
        public double? Valor_cheque { get; set; } = null;

        [Column("valor_efectivo")]
        public double? Valor_efectivo { get; set; } = null;

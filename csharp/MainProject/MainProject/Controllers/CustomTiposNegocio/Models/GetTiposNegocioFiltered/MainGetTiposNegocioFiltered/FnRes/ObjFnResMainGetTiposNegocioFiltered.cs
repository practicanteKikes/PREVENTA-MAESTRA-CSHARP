...
namespace MainProject.Controllers.CustomTiposNegocio.Models.GetTiposNegocioFiltered.MainGetTiposNegocioFiltered.FnRes
{
    public class ObjFnResMainGetTiposNegocioFiltered
    {
        ...
        public List<TipoNegocioMaestraCustomized> Kdata { get; set; } = new List<TipoNegocioMaestraCustomized>();
    }
}

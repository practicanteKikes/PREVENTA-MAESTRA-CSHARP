...
using MainProject.Controllers.CmMotivosNc.Controllers;
...
using MainProject.Controllers.CmMotivosNc.Models.CmMotivosNcFiltered.CmMotivosNcObtainObjectListAzync;
using MainProject.Controllers.CmMotivosNc.Models.CmMotivosNcFiltered.CmMotivosNcDefaultFilterParams;
using MainProject.Services.CustomHelper.Models.FnRes;
using MainProject.Controllers.CmMotivosNc.Models.CmMotivosNcFiltered.CmMotivosNcObtainTotalRowsFilteredWithOutLimit;
using MainProject.Services.CustomSybase.Models.QueryAAAModelDefaultFnResFTRowsAzync;
using MainProject.Controllers.CmMotivosNc.Models.CmMotivosNcAll;

namespace MainProject.Controllers.CmMotivosNc.Services.Impl
{
    public class CmMotivosNcService : ICmMotivosNc
    {
        // INJECTED
        ...
        )
        {
            ...
            // ===== TRANSLATION INIT =====
            var controllerType = typeof(CmMotivosNcController);
            ...
            _localizer = factory.Create("CmMotivosNc.Resources.CmMotivosNcController", assemblyObj.Name);
            // ===== TRANSLATION END =====
        ...
        public async Task<string> CmMotivosNcMainGetFilteredAsync(string ls_ctrl_json)
        {
            CmMotivosNcFnResMainGetFilteredDev objFnResDev = new();
            ...
            if (true)
            {
                ...
                if (!httpContext.Request.Headers.TryGetValue("Authorization", out var authorizationHeader))
                {
                    ...
                    return this.CmMotivosNcResponseFormatGetFiltered(objFnResDev, lb_developer_mode);
                }
            ...
            if (true)
            {
                ...
                List<CmMotivosNcModelJsonCustom> rowList = new(); // Retornaré customizado por defecto
                ...
                CmMotivosNcFnResObtainObjList ObtainFilteredObjListResult = await this.CmMotivosNcObtainObjectListAzync();
                ...
                if (ObtainFilteredObjListResult.Ksuccess && ObtainFilteredObjListResult.Kdata.Count >= 0)
                {
                    ...
                    if (true)
                    {
                        ...
                        var user = new CmMotivosNcModelJsonCustom();
                        
                        for (int i = 0; i < li_total_registros; i++)
                        {
                            objFnResDev.Kdata.Add(new CmMotivosNcModelJsonCustom());
                            var currentModel = ObtainFilteredObjListResult.Kdata[i];

                            objFnResDev.Kdata[i].Id = currentModel.Id;
                            
                            objFnResDev.Kdata[i].Id_motivo = currentModel.Id_motivo?.Trim();
                            objFnResDev.Kdata[i].Nom_motivo = currentModel.Nom_motivo?.Trim();                                                        
                            objFnResDev.Kdata[i].Fec_registro = currentModel.Fec_registro;
                            objFnResDev.Kdata[i].Fec_act_int = currentModel.Fec_act_int;
                ...
                var ObtainTotalRowsFilWithOutLimitCliRs = await this.CmMotivosNcObtainTotalRowsFilteredWithOutLimit();
                // ERROR ???
        ...
        // API publica por ahora
        public async Task<string> CmMotivosNcMainGetAllAsync(string ls_ctrl_json)
        {
            CmMotivosNcFnResMainGetAllDev objFnResDev = new();
            ...
            if (true)
            {
                ...
                if (!httpContext.Request.Headers.TryGetValue("Authorization", out var authorizationHeader))
                {
                    ...
                    return CmMotivosNcResponseFormatGetAll(objFnResDev, lb_developer_mode);
                }
            ...
            if (true)
            {
                // Llamar a obtain
                // BD CONSULTAR REGISTROS FILTRADOS
                CmMotivosNcFnResObtainAllObjectList obtainModelAllObjListResult = await this.CmMotivosNcObtainAllObjectListAzync();
                ...
                if (obtainModelAllObjListResult.Ksuccess && obtainModelAllObjListResult.Kdata.Count >= 0)
                {
                    ...
                    if (true)
                    {
                        ...
                        for (int i = 0; i < li_total_registros; i++)
                        {
                            objFnResDev.Kdata.Add(new CmMotivosNcModelAllJsonCustom());
            ...
            // Return expected response
            return CmMotivosNcResponseFormatGetAll(objFnResDev, lb_developer_mode); // on fail json received, activate developerMode
        }


        // Define a custom helper
        public async Task<CmMotivosNcFnResObtainObjList> CmMotivosNcObtainObjectListAzync()
        {
            // INICIALIZAMOS VALORES DEFECTO DE RESPUESTA
            CmMotivosNcFnResObtainObjList objFnResDev = new();
            ...
            try
            {
                ls_jsonresponse_retrieve_filtered = await this.CmMotivosNcRetrieveDbAllFilteredAzync(); // get rows filtered and limited                
            }
            ...
            CmMotivosNcResAjaxFilteredAzync dbSearchResult = new(); // Force to be an object
            CmMotivosNcResAjaxFilteredAzync? dbSearchResultOrNull = null; // necesary variable to try catch to cast postman json object            
            try
            {
                dbSearchResultOrNull = JsonSerializer.Deserialize<CmMotivosNcResAjaxFilteredAzync>(ls_jsonresponse_retrieve_filtered, _currentJsonOptions);
            }
            catch (JsonException e)
            {
                // Header response [500] Server error
            ...
            dbSearchResult = dbSearchResultOrNull ?? new CmMotivosNcResAjaxFilteredAzync();
        ...
        // Define a custom helper
        public async Task<string> CmMotivosNcRetrieveDbAllFilteredAzync()
        {
            CmMotivosNcFnResDefaultFilterParams aParams = this.CmMotivosNcDefaultFilterParams();
            ...
            string ls_jsonres = await _customSybaseService.CmMotivosNcQueryFilteredAzync(la_params_remote); // Esperamos una json de respuesta            
            return ls_jsonres;
        }


        // Define a custom helper
        public CmMotivosNcFnResDefaultFilterParams CmMotivosNcDefaultFilterParams()
        {
            CmMotivosNcFnResDefaultFilterParams aParams = new();
        ...
        // Define a custom helper
        public async Task<CmMotivosNcFnResObtainTotalRowsFWOL> CmMotivosNcObtainTotalRowsFilteredWithOutLimit()
        {
            // INICIALIZAMOS VALORES DEFECTO DE RESPUESTA
            CmMotivosNcFnResObtainTotalRowsFWOL objFnResDev = new();
            ...
            try
            {
                ls_database_response = await this.CmMotivosNcRetrieveDbAllFilteredTotalRowsAzync();
            }
            catch (JsonException e)
            {
                // Header response [500] Server error
        ...
        //// Define a custom helper
        public async Task<string> CmMotivosNcRetrieveDbAllFilteredTotalRowsAzync()
        {
            CmMotivosNcFnResDefaultFilterParams aParams = this.CmMotivosNcDefaultFilterParams();
            ...
            string ls_jsonres = await _customSybaseService.CmMotivosNcQueryFilteredTotalRowsAzync(la_params_remote); // Esperamos una json de respuesta
            return ls_jsonres;
        }
        ...
        private string CmMotivosNcResponseFormatGetFiltered(CmMotivosNcFnResMainGetFilteredDev stdFnResDev, bool developerMode = false)
        {
            var httpContext = _customHelper.GetCurrentHttpContext();
            var Request = httpContext.Request;
        ...
        // Define a custom helper
        private string CmMotivosNcResponseFormatGetAll(CmMotivosNcFnResMainGetAllDev stdFnResDev, bool developerMode = false)
        {
        ...
        // Define a custom helper
        public async Task<CmMotivosNcFnResObtainAllObjectList> CmMotivosNcObtainAllObjectListAzync()
        {
            // INICIALIZAMOS VALORES DEFECTO DE RESPUESTA
            CmMotivosNcFnResObtainAllObjectList objFnResDev = new();
            ...
            try
            {
                ls_jsonresponse_bdtable_all = await this.CmMotivosNcRetrieveDbAllAzync(); // get all rows                
            }
            catch (JsonException e)
            {
                // Header response [500] Server error
            ...
            // ERRORRR PARSING JSON???
            CmMotivosNcResAjaxAllAzync dbSearchResult = new(); // Force to be an object
            CmMotivosNcResAjaxAllAzync? dbSearchResultOrNull = null; // necesary variable to try catch to cast postman json object            
            try
            {
                dbSearchResultOrNull = JsonSerializer.Deserialize<CmMotivosNcResAjaxAllAzync>(ls_jsonresponse_bdtable_all, _currentJsonOptions);
            }
            catch (JsonException e)
            {
                // Header response [500] Server error
            ...
            dbSearchResult = dbSearchResultOrNull ?? new CmMotivosNcResAjaxAllAzync();
        ...
        public async Task<string> CmMotivosNcRetrieveDbAllAzync()
        {
            string ls_jsonres = await _customSybaseService.CmMotivosNcQueryAllAzync();
            return ls_jsonres;
        }

namespace MainProject.Controllers.CustomDepartamentos.Models.DepartamentosFiltered.MainGetDepartamentosFilteredAsync
{
    public class FnResMainGetDepartamentosFiltered
    {
        ...
        public List<ModelDepartamentoJsonCustom> Kdata { get; set; } = new List<ModelDepartamentoJsonCustom>();
    }
}

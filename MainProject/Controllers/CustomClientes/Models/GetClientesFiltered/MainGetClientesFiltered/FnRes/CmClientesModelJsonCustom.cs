namespace MainProject.Controllers.CustomClientes.Models.GetClientesFiltered.MainGetClientesFiltered.FnRes
{
    public class CmClientesModelJsonCustom
    {
        ...
        public string? Cupo { get; set; } = null;

        public string? Saldo { get; set; } = null;

        public string? Anticipos { get; set; } = null;
        ...
        public string? Plazo_factura { get; set; } = null;
        ...
        public string? Correo_factu_electronica { get; set; } = null; // added 17 feb 2025
    }
}

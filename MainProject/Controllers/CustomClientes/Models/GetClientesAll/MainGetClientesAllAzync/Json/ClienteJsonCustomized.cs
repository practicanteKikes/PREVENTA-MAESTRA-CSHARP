namespace MainProject.Controllers.CustomClientes.Models.GetClientesAll.MainGetClientesAllAzync.Json
{
    public class ClienteJsonCustomized
    {
        ...
        // las otras dos columnas ya estaban originalmente en oe004_cliente_sucursal

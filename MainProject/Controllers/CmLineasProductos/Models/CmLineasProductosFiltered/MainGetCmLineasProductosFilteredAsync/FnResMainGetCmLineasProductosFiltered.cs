...
{
    public class FnResMainGetCmLineasProductosFiltered
    {
        ...
        public List<ModelCmLineasProductosJsonCustom> Kdata { get; set; } = new List<ModelCmLineasProductosJsonCustom>();
    }
}
